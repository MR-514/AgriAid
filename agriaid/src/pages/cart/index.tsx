...
// Update useState with the correct type
const [productsInCart, setProductsInCart] = useState<ProductItem[]>([]);

// Ensure extractVariantDetails returns ProductItem[]
const extractVariantDetails = (data: any[]): ProductItem[] => {
...
// In your fetchCartData function
const fetchCartData = async () => {
  ...
  try {
    ...
    setProductsInCart(extractedDetails); // Ensure extractedDetails is of type ProductItem[]
  } catch (error) {
