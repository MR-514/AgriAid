...
export default function AddressForm({ onSubmitForm, showCart }: AddressFormProps) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center">
            <form
                className="p-4 flex gap-4 flex-wrap text-neutral-900 border border-gray-300 rounded-lg shadow-lg"
                style={{ maxWidth: 800, padding: 30 }}
                onSubmit={onSubmit}
            >
                <h2 className="w-full text-3xl typography-headline-4 md:typography-headline-3 font-bold">
